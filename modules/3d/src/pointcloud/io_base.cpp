...
void BasePointCloudDecoder::readData(std::vector<Point3f> &points, std::vector<Point3f> &normals, std::vector<Point3f> &colors)
{
    std::vector<std::vector<int32_t>> indices;
    readData(points, normals, colors, indices);
}
